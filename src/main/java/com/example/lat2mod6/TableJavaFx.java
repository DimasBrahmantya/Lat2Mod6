...
public class TableJavaFx extends Application {
    ...
    public void start(Stage stage) {
        ...
        final ObservableList<Mahasiswa> data = FXCollections.observableArrayList (
                new Mahasiswa ("Muhammad Abdan Fikri", "202210370311013", "Abdan@gmail.com"),
                new Mahasiswa ("Dimas Brahmantya", "2021103703111010", "Dimas@gmail.com")
        );
